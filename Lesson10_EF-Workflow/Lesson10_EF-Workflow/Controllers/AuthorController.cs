...
namespace Lesson10_EF_Workflow.Controllers
{
    public class AuthorController : Controller
    {
        private readonly Lesson10_EF_WorkflowContext _context;

        public AuthorController(Lesson10_EF_WorkflowContext context)
        {
            _context = context;
        }
