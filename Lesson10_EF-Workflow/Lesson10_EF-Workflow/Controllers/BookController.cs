...
namespace Lesson10_EF_Workflow.Controllers
{
    public class BookController : Controller
    {
        ...
        public BookController(Lesson10_EF_WorkflowContext context)
        {
            _context = context;
        }
        ...
        {
            var lesson10_EF_WorkflowContext = _context.Books.Include(b => b.Author);
            return View(await lesson10_EF_WorkflowContext.ToListAsync());
        }
